...
var scannerList = 111 ;
var simpleCounter = 0 ;
var pollInterval = 1000 * 30; // 1 minute, in milliseconds
var timerId ;
var resultTable;
...
function doRequest(specificScanner)
{
    ...
    var toScanCount = scannerList.length ;
    ...
    for (var i in scannerList) 
    {
        ...
        xhr.onload = function(e) 
        {
          ...
          {
              saveStorage() ;  
              // display number of not validated scanner
              var unvalidatedScanner = 0 ;
              for (var j in scannerList) 
              {
                  var checkScanner = scannerList[j] ;
